...
class ToaDoFollowTikTok : Service() {
    ...
    override fun onCreate() {
        ...
        if (followtiktokx != 0f && followtiktoky != null) {
            initialX = toadohandfollowtiktokx!!.toInt()
            initialY = toadohandfollowtiktoky!!.toInt()
        }else{
    ...
    private fun updateCoordinates(px:Int, py:Int) {
        ...
        toadohandfollowtiktokx = px.toFloat()
        toadohandfollowtiktoky = py.toFloat()
        followtiktokx = x.toFloat()
        followtiktoky = y.toFloat()
    }
